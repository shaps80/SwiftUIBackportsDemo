...
public struct UIKitIntrospectionView<TargetViewType: UIView>: UIViewRepresentable {
    ...
    public func updateUIView(_ view: IntrospectionUIView, context: UIViewRepresentableContext<UIKitIntrospectionView>) {
        DispatchQueue.main.async {
            guard let targetView = self.selector(view) else { return }
